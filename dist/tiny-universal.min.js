(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("lodash/forEach"), require("lodash/get"), require("lodash/set"), require("react-dom/server"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "lodash/forEach", "lodash/get", "lodash/set", "react-dom/server"], factory);
	else if(typeof exports === 'object')
		exports["tiny-universal"] = factory(require("react"), require("lodash/forEach"), require("lodash/get"), require("lodash/set"), require("react-dom/server"));
	else
		root["tiny-universal"] = factory(root["react"], root["lodash/forEach"], root["lodash/get"], root["lodash/set"], root["react-dom/server"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__) {
...
exports.wrapClientApp = exports.wrapServerApp = undefined;
...
var wrapServerApp = exports.wrapServerApp = function wrapServerApp(RootComponent, routes, props) {
...
var wrapClientApp = exports.wrapClientApp = function wrapClientApp(RootComponent, routes) {
...
var _createUniversalWrappers = __webpack_require__(6);

function createTinyApp(RootComponent, Routes) {
  return (0, _createUniversalWrappers.wrapClientApp)(RootComponent, Routes);
}
...
function createTinyServer(RootComponent, Routes, template) {
  return function (req, res, next) {
    ...
    (0, _resolveRoute2.default)(resolve, routeParams).then(function (resolvedData) {
      ...
      templateString = templateString.replace('<% appRoot %>', (0, _createUniversalWrappers.wrapServerApp)(RootComponent, Routes, _extends({
        location: {
          pathname: pathname,
          search: search
        },
