...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_25__) {
...
var _clientWrapper = __webpack_require__(19);
...
var _curry = __webpack_require__(22);
...
var _serverWrapper = __webpack_require__(20);
...
var _getRouteMap = __webpack_require__(16);
...
var _parseTemplate = __webpack_require__(18);
...
var handleSuccess = function handleSuccess(res, response) {
  return res.send(response);
};

var handleError = function handleError(res, error) {
  return res.status(500).send((0, _getString2.default)('promise.error', error));
};
...
function createTinyServer(config) {
  ...
  return function (req, res, next) {
    ...
    var successHandler = (0, _curry2.default)(handleSuccess)(res);
    var errorHandler = (0, _curry2.default)(handleError)(res);
    ...
    (0, _resolveRoute2.default)(resolve, routeParams).then(function (resolvedData) {
      ...
      (0, _parseTemplate2.default)(template, currentRoute, appRoot).then(successHandler);
    }, errorHandler);
  };
}
...
var _getTemplateTokens = __webpack_require__(17);
