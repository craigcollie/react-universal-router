...
var _universalWrappers = __webpack_require__(21);

exports.default = _universalWrappers.wrapClientApp;
...
function createTinyServer(RootComponent, Routes, template) {
  return function (req, res, next) {
    ...
    (0, _resolveRoute2.default)(resolve, routeParams).then(function (resolvedData) {
      ...
      templateString = templateString.replace('<% appRoot %>', (0, _universalWrappers.wrapServerApp)(RootComponent, Routes, _extends({
        location: {
          pathname: pathname,
          search: search
        },
