(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("lodash/forEach"), require("lodash/set"), require("lodash/get"), require("lodash/reduce"), require("react-dom/server"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "lodash/forEach", "lodash/set", "lodash/get", "lodash/reduce", "react-dom/server"], factory);
	else if(typeof exports === 'object')
		exports["tiny-universal"] = factory(require("react"), require("lodash/forEach"), require("lodash/set"), require("lodash/get"), require("lodash/reduce"), require("react-dom/server"));
	else
		root["tiny-universal"] = factory(root["react"], root["lodash/forEach"], root["lodash/set"], root["lodash/get"], root["lodash/reduce"], root["react-dom/server"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__) {
...
var _hasMatchingRoute = __webpack_require__(19);

var _hasMatchingRoute2 = _interopRequireDefault(_hasMatchingRoute);

var _getTokenProps = __webpack_require__(18);

var _getTokenProps2 = _interopRequireDefault(_getTokenProps);
...
function createTinyServer(RootComponent, Routes, template) {
  return function (req, res, next) {
    ...
    (0, _resolveRoute2.default)(resolve, routeParams).then(function (resolvedData) {
      ...
      var tokenProps = (0, _getTokenProps2.default)(tokens);
      ...
      res.send((0, _parseTemplate2.default)(templateString, tokens, appRoot));
    });
  };
}
...
function getTokenProps(tokens) {
  return (0, _reduce2.default)(tokens, function (acc, val, key) {
    (0, _set2.default)(acc, key, val);
    return acc;
  }, {});
}

exports.default = getTokenProps;
